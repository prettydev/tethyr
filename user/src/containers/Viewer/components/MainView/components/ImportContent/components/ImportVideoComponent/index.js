...
class ImportVideo extends React.Component {
  ...
  componentDidMount() {
    this.getVideoInfo(this.props.url);
  }
  ...
  getFacebookInfo = (url) => {
    ...
    video['datePublish'] = "";
    video['author_link'] = 'https://www.facebook.com';
    video['thumbnail'] = '';
    video['video_title'] = '';
    video['description'] = '';
    video['video_author'] = '';
    video['interface_link'] = "https://www.facebook.com/watch/?v=" + video_id;
    video['author_img'] = '';
  ...
  render() {
    const { video, validUrl } = this.state;
    return (
      <div>
        { validUrl &&
          <div>
