...
loadPlayListFromDB = () => {
  ...
  showPlaylist = (index) => {
    ...
    if(this.state.settingsHeight === "hide")
    {
      ...
      if (node instanceof HTMLElement) {
        let Win1cube = node.querySelector('.RightSideArea');
  ...
  renderButtons = (index) => {
    const { muted,  showPlaylist, playlist, video} = this.state;  
    if(!playlist[index]) {
      return (
        <div className="ButtonBar" id={`C${index + 1}_BUT`}>
          <img alt='button' className="imgBtn" src={images.btnVideoInactive} height="20" />
          <img alt='button' className="imgBtn" src={images.btnAudioInactive} height="20" />
          <img alt='button' className="imgBtn" src={images.btnPlaylistInactive} height="20"/>
      ...
      return (
        <div className="ButtonBar" id={`C${index + 1}_BUT`}>
          <img alt='button' className="imgBtn" src={images.btnVideoInactive} height="20" />
          <img alt='button' className="imgBtn" src={images.btnAudioInactive} height="20" />
          <img alt='button' className="imgBtn" src={showPlaylist === index ? images.btnPlaylistActive : images.btnPlaylistInactive} height="20" onClick={() => { this.showPlaylist(index) }} />
          <img src={ images.playlistControlsDotOff } className="previewBtn" alt="ratingRadio" title="Dot this"/>
          <img src={ images.playlistControlsHideOff} className="previewBtn" alt="hideBtn" title="Hide this"/>
          <img src={images.interface_link} className="previewBtn" alt="interface_link" title="Open Source"/>
        </div>
      ...
      return (
        <div className="ButtonBar" id={`C${index + 1}_BUT`}>
          <img alt='button' className="imgBtn" src={images.btnVideoNotAvailable} height="20"  />
          <img alt='button' className="imgBtn" src={muted[index] ? images.btnAudioInactive : images.btnAudioActive} height="20" onClick={() => { this.activateAudio(index) }} />
          <img alt='button' className="imgBtn" src={showPlaylist === index ? images.btnPlaylistActive : images.btnPlaylistInactive} height="20" onClick={() => { this.showPlaylist(index) }} />
  ...
  handleSettingsHeightChange = (val) => {
    ...
    if (node instanceof HTMLElement) {
      Win1cube = node.querySelector('.RightSideArea');
...
export default withRouter(connect(null, mapDispatchToProps)(M4));
