...
class SearchVideosContent extends Component {
    ...
    render() {
        ...
        return (
            <div className = 'videoSearch'>
                <div className={'video-result ' + this.props.settingsHeight } >
...
export default connect(null, mapDispatchToProps)(SearchVideosContent);